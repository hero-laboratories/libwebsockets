...
int lws_plat_service(struct lws_context *context, int timeout_ms) {
...
LWS_EXTERN int _lws_plat_service_tsi(struct lws_context *context,
                                     int timeout_ms, int tsi) {
  ...
  if (pt->context->tls_ops && pt->context->tls_ops->fake_POLLIN_for_buffered)
...
void lws_plat_service_periodic(struct lws_context *context) {}
